...
execute unless block ~ ~ ~ #minecraft:wither_immune run summon bat ~ ~ ~ {NoAI:true,CustomName:"世界毁灭者"}
execute unless block ~ ~ ~ #minecraft:wither_immune run execute as @p at @s run damage @e[type=bat,name="世界毁灭者",sort=nearest] 999 dragon_breath
